...
An artifact whose `paths` is None searches for nothing. dleapp.py:495 hands such an
...
No DLEAPP artifact declares `paths` as None today, so that branch is code present and
unexercised here and this change alters no DLEAPP output. It is levelled from iLEAPP,
