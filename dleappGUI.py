...
def open_lava(project_path, launcher):
    ...
    try:
        ...
        tk_msgbox.showerror(
            ...
            message=f'DLEAPP could not open the project in LAVA:\n{ex}',
            parent=main_window)
        return
    main_window.quit()
...
def open_folder(output_path):
    ...
    try:
        ...
        tk_msgbox.showerror(
            ...
            message=f'DLEAPP could not open the output folder:\n{ex}',
            parent=main_window)
...
def process(casedata):
    ...
    if is_valid:
        ...
        if crunch_successful:
            ...
            history.record_recent_run(leapp_name.lower(), dleapp_version, lava_project_path)
