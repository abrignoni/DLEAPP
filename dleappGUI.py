...
def load_profile():
    ...
    destination_path = tk_filedialog.askopenfilename(parent=main_window, 
                                                     ...
                                                     filetypes=(('DLEAPP Profile', '*.dlprofile'),))
...
## Theme properties
theme_bgcolor = '#494ca2'
theme_inputcolor = '#c6cbef'
theme_fgcolor = '#e3e7f1'
theme_button = '#8186d5'
...
style.map('TButton', 
          background=[('active', 'white'), ('!disabled', theme_button)], 
          foreground=[('active', theme_button), ('!disabled', 'white')])
style.configure('TEntry', fieldbackground=theme_inputcolor, highlightthickness=0, foreground='black')
style.configure(
...
title_label = ttk.Label(
    title_frame, 
    text='Drones Logs, Events, And Properties Parser', 
    font=('Helvetica 22'))
title_label.pack(pady=4)
github_label = ttk.Label(
    title_frame, 
    text='https://github.com/abrignoni/DLEAPP', 
    font=('Helvetica 14'))
