...
Shared by all six spec files so the bundling rule lives in one place. Ported from iLEAPP,
with the third-party notices added.
...
copy in bin/. When it is absent the build still succeeds and ships without native Apple
Unified Log support.
