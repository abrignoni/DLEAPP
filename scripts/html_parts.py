...
"""
                <div class="justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
                    <img src="_elements/DLEAPP_banner.png" alt="DLEAPP banner">
                    ...
                    <div class="card bg-white mb-3" style="max-width: 500px; margin:auto">
                        <div class="row no-gutters">
                            ...
                            <div class="card-body">
                                ...
                                <!--Github-->
                                <a class="btn-floating btn-git" type="button" role="button" href="https://github.com/abrignoni/dleapp" target="_blank"><i class="fab fa-github"></i> Project Home </a>
...
"""
    <div class="alert alert-light mb-4 bg-white" style="border-style: none">
        <h4 class="text-center">DLEAPP contributors</h4>
