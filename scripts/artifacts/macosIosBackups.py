...
__artifacts_v2__ = {
    "macosIosBackups": {
        ...
        "notes": "One row per backup folder directly inside a MobileSync/Backup folder, read from "
                 ...
                 "established. The pattern keys on the MobileSync/Backup folder name; for Windows "
                 "Apple's page names only the %USERPROFILE% and %AppData% starting points, and no "
