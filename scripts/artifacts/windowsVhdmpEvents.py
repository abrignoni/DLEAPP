...
__artifacts_v2__ = {
    "virtualDiskEvents": {
        ...
        "notes": "Read from Microsoft-Windows-VHDMP-Operational.evtx, named in the "
                 ...
                 "inserted values removed; for 50 and 51 it reads 'Performing VHD "
                 "operation' and 'Successfully performed VHD operation', and Operation "
                 "carries the VhdMetaOps value the message inserts (manifest as registered "
