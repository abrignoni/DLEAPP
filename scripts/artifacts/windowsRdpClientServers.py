...
__artifacts_v2__ = {
    "rdpClientServers": {
        ...
        "notes": "Reads Software\\Microsoft\\Terminal Server Client in each NTUSER.DAT: the MRU values "
                 ...
                 "Position 0 is the most recent entry in that list. A Servers subkey is reported "
                 "with its UsernameHint value as stored and whether it has a non-empty CertHash "
                 "value; an MRU entry whose text matches no Servers subkey name exactly, "
