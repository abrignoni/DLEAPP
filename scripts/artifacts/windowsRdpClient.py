...
__artifacts_v2__ = {
    "rdpClientConnections": {
        ...
        "notes": "Read from "
                 ...
                 "held a base64 string followed by a hyphen on 27 of 33 rows, two base64 "
                 "strings joined by a hyphen on 4 and a hyphen alone on 2, and the user "
                 "name that was hashed is not recorded. User SID is the SID in the "
                 "record's Security element and Process ID the process ID in its Execution "
                 "element; User SID held one value on all 108 rows of pc_mus_001_win11. "
