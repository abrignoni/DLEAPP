...
__artifacts_v2__ = {
    "taskSchedulerRegistrations": {
        ...
        "notes": "Read from Microsoft-Windows-TaskScheduler%4Operational.evtx, named in "
                 ...
                 "records with Event ID 106, 140 or 141 are read. Event is a short form of "
                 "the provider manifest's message for each, which names an account that "
                 "registered, updated or deleted the task (manifest as registered on "
                 "Windows 11 build 22621.819, published in nasbench's EVTX-ETW-Resources "
                 "repository: "
                 "https://github.com/nasbench/EVTX-ETW-Resources/blob/065476ce28fa290d088214b94ba698ee3558fe06/ETWProvidersManifests/Windows11/22H2/W11_22H2_Pro_20221115_22621.819/WEPExplorer/Microsoft-Windows-TaskScheduler.xml#L924-L938, "
                 "#L1381-L1395 and #L1396-L1410). Task Name is TaskName and Account is "
                 "UserContext for 106 and UserName for 140 and 141, as stored. Event Time "
                 "(UTC) is the record's TimeCreated SystemTime, which python-evtx renders "
    ...
    "taskSchedulerActions": {
        ...
        "notes": "Read from Microsoft-Windows-TaskScheduler%4Operational.evtx, named in "
                 ...
                 "Engine Process ID are TaskName, ActionName, TaskInstanceId, ResultCode "
                 "and EnginePID as stored; the manifest's version 0 of both events carries "
                 "no EnginePID and version 0 of 201 no ResultCode, and 200 never carries "
                 "ResultCode, so Return Code is blank on 200 rows. Event Time (UTC) is the "
