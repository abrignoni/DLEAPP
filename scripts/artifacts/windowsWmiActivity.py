...
__artifacts_v2__ = {
    ...
    "wmiProviderActivity": {
        ...
        "notes": "Read from Microsoft-Windows-WMI-Activity%4Operational.evtx, named in the "
                 ...
                 "each registered image. Component and Possible Cause held the same value "
                 "on every 5858 row of lonewolf_win10 (156 rows), and on 173 of 174 rows "
                 "on af_case2_win10 and 235 of 246 on pc_mus_001_win11. Event Time (UTC) "
                 "is the record's TimeCreated SystemTime, which python-evtx renders from "
