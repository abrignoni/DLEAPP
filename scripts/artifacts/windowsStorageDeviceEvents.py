...
__artifacts_v2__ = {
    ...
    "pnpDeviceConfiguration": {
        ...
        "notes": "Read from Microsoft-Windows-Kernel-PnP%4Configuration.evtx, named in the "
                 ...
                 "Event ID 400, 410 or 420 are read. Event is the first sentence of the "
                 "provider manifest's message for each without the device it names, "
                 "'Device %1 was configured.', 'Device %1 was started.' and 'Device %1 was "
                 "deleted.' (manifest as registered on Windows 11 build 22621.819, "
