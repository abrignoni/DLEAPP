...
__artifacts_v2__ = {
    "shellCoreRunKeyEvents": {
        ...
        "notes": "Read from Microsoft-Windows-Shell-Core%4Operational.evtx, named in the "
                 ...
                 "manifest's message for each, without the key, command and PID it "
                 "inserts: 9705 and 9706 'Started' and 'Finished enumeration of commands "
                 "for registry key', 9707 'Started execution of command' and 9708 "
                 "'Finished execution of command' (manifest as registered on Windows 11 "
