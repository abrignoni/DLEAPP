...
__artifacts_v2__ = {
    "defenderExclusions": {
        ...
        "notes": "Read from the SOFTWARE hive, named in the report's located-at line, with "
                 ...
                 "policies to the value names Exclusions_Extensions, Exclusions_Paths and "
                 "Exclusions_Processes under Software\\Policies\\Microsoft\\Windows "
                 "Defender\\Exclusions ('Policy CSP - Defender', snapshot "
