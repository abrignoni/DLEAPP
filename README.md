...
```
$ python dleapp.py -t <zip | tar | fs | gz | raw> -i <path_to_extraction> -o <path_for_report_output>
```
...
This runs DLEAPP end to end on your extraction and prints ready-to-paste `sample_data`
